            ...
            controls=[
                ...
                ft.Row(
                    controls=[
                        ft.Container(
                            ft.Text(
                                "Optimiza tu día de trabajo con nuestro asistente digital: desde organizar carpetas y convertir archivos hasta enviar correos masivos \n              personalizados y eliminar archivos temporales. Simplifica tus tareas, ahorra tiempo y mejora tu productividad",
                                size=24,
                                font_family="georgia",
                                color="#b89789",
                            ),
                            margin=ft.margin.only(40, bottom=45, top=20),
                        )
                    ],
                    alignment=ft.MainAxisAlignment.CENTER,
                ),
